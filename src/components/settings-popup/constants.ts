...
export const REGION_OPTION_DEFAULT_CHECKED_VALUE = true;
export const BLOCK_OPTION_DEFAULT_CHECKED_VALUE = true;
export const PRODUCTION_STATION_OPTION_DEFAULT_CHECKED_VALUE = true;
export const FIELD_OPTION_DEFAULT_CHECKED_VALUE = true;
export const RESERVOIR_OPTION_DEFAULT_CHECKED_VALUE = true;
export const WELL_OPTION_DEFAULT_CHECKED_VALUE = true;
export const COMPLETION_OPTION_DEFAULT_CHECKED_VALUE = true;
